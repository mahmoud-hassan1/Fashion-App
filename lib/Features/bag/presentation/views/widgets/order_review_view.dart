...
import 'package:online_shopping/Features/bag/presentation/cubits/order_review.dart/order_review_cubit.dart';
...
class OrderReviewView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<OrderReviewCubit>(
      create: (context) => OrderReviewCubit(BagRepoImpl(FavouriteRepoImpl(firestore: FirebaseFirestore.instance))),
