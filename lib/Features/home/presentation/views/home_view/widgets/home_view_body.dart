...
List<Product> products=[Product(categories: ["Sale"], id: "1", name: "evening dress", price:200 , image:"assets/images/item.png", description: "Dummy description", rate: 4.5, sellerId: "dummySellerId", stock: 10 ),Product(categories: ["Sale"], id: "1", name: "evening dress", price:200 , image:"assets/images/item.png", description: "Dummy description", rate: 4.5, sellerId: "dummySellerId", stock: 10 ),Product(categories: ["Sale"], id: "1", name: "evening dress", price:200 , image:"assets/images/item.png", description: "Dummy description", rate: 4.5, sellerId: "dummySellerId", stock: 10 ),Product(categories: ["Sale"], id: "1", name: "evening dress", price:200 , image:"assets/images/item.png", description: "Dummy description", rate: 4.5, sellerId: "dummySellerId", stock: 10 )];
  @override
