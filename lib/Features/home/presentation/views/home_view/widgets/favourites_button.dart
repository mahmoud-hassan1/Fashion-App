    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: const BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(blurRadius: 5, color: Colors.grey, offset: Offset(4, 4))
            ]),
        child: Icon(
            blocInstance.isFavourite(productId: product.id)
                ? Icons.favorite
                : Icons.favorite_border_rounded,
            color: blocInstance.isFavourite(productId: product.id)
                ? AppColors.kRed
                : Colors.black),
      ),
    );
