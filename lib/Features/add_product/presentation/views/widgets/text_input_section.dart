...
class TextInputSection extends StatelessWidget {
  const TextInputSection({
    ...
    required TextEditingController stockController, required TextEditingController priceAfterDiscountController,required TextEditingController discountController,
  }) :_priceAfterDiscountController=priceAfterDiscountController,_discountController=discountController, _nameController = nameController, _subtitleController = subtitleController, _descriptionController = descriptionController, _priceController = priceController, _stockController = stockController;
