    ...
    delegate: SliverChildBuilderDelegate(
      (BuildContext context, int index) {
        return InkWell(
          ...
          Navigator.push(context, MaterialPageRoute(builder: (context) =>  ProductsScreen(title: "${kTypes[widget.tabController.index]}'s ${kCategoryList[index].first}"),));
          },
          child: AspectRatio(
            aspectRatio: 3/1,
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Image.asset(kCategoryList[index][1][widget.tabController.index],fit: BoxFit.fitWidth,),
                  ),
                ],
              ),
            ),
