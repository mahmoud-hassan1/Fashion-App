...
class FirestoreServices {
  ...
  Future<dynamic> getField(
      String collectionPath, String docName, String key) async {
    var data =
        await firestoreInstance.collection(collectionPath).doc(docName).get();
    return data.data()![key];
  }

  Future<void> setDocument(String collectionPath, Map<String, dynamic> data,
      [String? docName, bool merge = true]) async {
  ...
  Future<void> updateField(
      String collectionPath, String docName, Map<String, dynamic> data) async {
    await firestoreInstance
        .collection(collectionPath)
        .doc(docName)
        .update(data);
